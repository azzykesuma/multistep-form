...
const Step2Form = () => {
  ...
  return (
    <LayoutStep>
      <LayoutStep.Header>Select Plan</LayoutStep.Header>
      ...
      <div className="flex flex-col md:flex-row md:gap-3">
        {plansDetails.map((plan) => (
          <m.div
            ...
            key={plan.name}
            className={`flex items-center md:basis-1/3 md:gap-10 md:flex-col md:items-start gap-4 mb-4 shadow-md drop-shadow-sm p-2 rounded border-opacity-50
                      ${
      ...
      <div className={`flex bg-alabaster p-2 justify-center rounded gap-2 md:gap-6`}>
